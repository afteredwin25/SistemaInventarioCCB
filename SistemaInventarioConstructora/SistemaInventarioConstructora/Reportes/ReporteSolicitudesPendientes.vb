...
Public Class ReporteSolicitudesPendientes
    Private Sub ReporteSolicitudesPendientes_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub
    Sub ImprimirSolicitudesPendientes()
        Dim adaptador1, adaptador2, adaptador3, adaptador4, adaptador5, adaptador6, adaptador7, adaptador8, adaptador9 As SqlDataAdapter
        Dim reporte As New rptSolictudes
        Dim ds As New dsData1
        Dim sql1, sql2, sql3, sql4, sql5, sql6, sql7, sql8, sql9 As String
        ...
        sql8 = " Select * from Solicitudes where EstadoSolicitud = 'PENDIENTE'"
        sql9 = " Select * from Tecnicos"

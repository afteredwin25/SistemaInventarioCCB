...
Public Class ReporteArticulosEntregadosSabaneta
    Private Sub CrystalReportViewer1_Load(sender As Object, e As EventArgs) Handles CrystalReportViewer1.Load

    End Sub

    Sub ImprimirArticulosEntregadosSabaneta()
        ...
        sql3 = " Select * from  CargoActivos where EstadoArticulo <> 'ELIMINADO' AND Sede = 'Sabaneta' "

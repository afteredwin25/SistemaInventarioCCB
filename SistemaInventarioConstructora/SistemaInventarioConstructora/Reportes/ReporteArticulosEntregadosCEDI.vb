...
Public Class ReporteArticulosEntregadosCEDI
    ...
    Sub ImprimirArticulosEntregadosCEDI()
        ...
        sql3 = " Select * from  CargoActivos where EstadoArticulo <> 'ELIMINADO' AND Sede = 'Cedi Caribe' "

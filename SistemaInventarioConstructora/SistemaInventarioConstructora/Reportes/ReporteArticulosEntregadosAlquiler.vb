...
Public Class ReporteArticulosEntregadosAlquiler
    Private Sub ReporteArticulosEntregadosAlquiler_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Sub ImprimirArticulosEntregadosAlquiler()
        ...
        sql1 = " Select * from Articulos where EstadoArticulo = 'ENTREGADO' AND TipoAdquisicion = 'Alquiler' "

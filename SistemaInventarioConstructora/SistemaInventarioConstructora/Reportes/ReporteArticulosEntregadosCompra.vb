...
Public Class ReporteArticulosEntregadosCompra
    Private Sub ReporteArticulosEntregadosCompra_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Sub ImprimirArticulosEntregadosCompra()
        ...
        sql1 = " Select * from Articulos where EstadoArticulo = 'ENTREGADO' AND TipoAdquisicion = 'Compra' "

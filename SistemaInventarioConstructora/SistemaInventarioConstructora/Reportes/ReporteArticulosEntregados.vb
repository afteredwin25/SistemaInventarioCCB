...
Public Class ReporteArticulosEntregados
    Private Sub CrystalReportAEntregados_Load(sender As Object, e As EventArgs) Handles CrystalReportAEntregados.Load

    End Sub

    Sub ImprimirArticulosEntregados()
        ...
        Try
            ...
            Me.CrystalReportAEntregados.ReportSource = reporte
    ...
    Private Sub ReporteArticulosEntregados_Load(sender As Object, e As EventArgs) Handles MyBase.Load

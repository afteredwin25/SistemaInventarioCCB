...
Public Class rptArtHurtados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisInvCCB.rptArtHurtados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptArtHurtados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptArtHurtados = New rptArtHurtados()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class ReporteTotalSolicitudes
    Private Sub ReporteTotalSolicitudes_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Sub ImprimirTotalSolicitudes()

...
Public Class ReporteArticulosEntregadosBarranquilla
    Private Sub CrystalReportViewer1_Load(sender As Object, e As EventArgs) Handles CrystalReportViewer1.Load

    End Sub
    Sub ImprimirArticulosEntregadosBarranquilla()
        ...
        sql3 = " Select * from  CargoActivos where EstadoArticulo <> 'ELIMINADO' AND Sede = 'Sede Barranquilla' "

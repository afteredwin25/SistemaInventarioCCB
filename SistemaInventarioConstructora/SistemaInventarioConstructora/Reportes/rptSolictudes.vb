...
Public Class rptSolictudes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisInvCCB.rptSolictudes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSolictudes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSolictudes = New rptSolictudes()
        rpt.Site = Me.Site
        Return rpt
    End Function

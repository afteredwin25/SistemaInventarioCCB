...
Public Class ReporteMantenimiento
    ...
    Sub ImprimirMantenimientoActivos()
        ...
        sql5 = " select * from Mantenimientos "
        ...
        Try
            ...
            adaptador5.Fill(ds, "Mantenimientos")
            adaptador6.Fill(ds, "Empleados")
            adaptador7.Fill(ds, "Puestos")


            reporte.SetDataSource(ds)
            Me.CrystalReportMantenimientos.ReportSource = reporte


        Catch ex As Exception
            MsgBox("Se ha mostrado el sigiente error " + ex.ToString + "Sistema Inventario")
    ...
    Private Sub CrystalReportMantenimientos_Load(sender As Object, e As EventArgs) Handles CrystalReportMantenimientos.Load

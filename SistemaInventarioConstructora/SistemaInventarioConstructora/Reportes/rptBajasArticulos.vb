...
Public Class rptBajasArticulos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisInvCCB.rptBajasArticulos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBajasArticulos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBajasArticulos = New rptBajasArticulos()
        rpt.Site = Me.Site
        Return rpt
    End Function

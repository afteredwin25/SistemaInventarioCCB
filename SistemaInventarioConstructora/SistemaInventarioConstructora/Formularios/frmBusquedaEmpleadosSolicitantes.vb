...
Public Class frmBusquedaEmpleadosSolicitantes
    Private Sub frmBusquedaEmpleadosSolicitantes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LlenarDatos()
    ...
    Sub LlenarDatos()
        ...
        sql = "Select Empleados.IdEmpleado, Empleados.Nombre, Empleados.Identidad, Empleados.Genero, Empleados.Telefono, Empleados.Correo, Empleados.Direccion,
                                Departamentos.NombreD, Puestos.NombreP  FROM Departamentos INNER JOIN Empleados ON Departamentos.IdDepartamento =  Empleados.IdDepartamento  
    ...
    Private Sub dgvEmpleados_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvEmpleados.CellDoubleClick
        frmSolicitantes.txtIdSolicitante.Text = CStr(dgvEmpleados.Item("IdEmpleado", dgvEmpleados.CurrentCell.RowIndex).Value)
        frmSolicitantes.txtNombreSolicitante.Text = CStr(dgvEmpleados.Item("Nombre", dgvEmpleados.CurrentCell.RowIndex).Value)
        frmSolicitantes.txtIdentidad.Text = CStr(dgvEmpleados.Item("Identidad", dgvEmpleados.CurrentCell.RowIndex).Value)

        frmSolicitantes.cboDepartamento.Text = CStr(dgvEmpleados.Item("NombreD", dgvEmpleados.CurrentCell.RowIndex).Value)
        frmSolicitantes.cboPuesto.Text = CStr(dgvEmpleados.Item("NombreP", dgvEmpleados.CurrentCell.RowIndex).Value)

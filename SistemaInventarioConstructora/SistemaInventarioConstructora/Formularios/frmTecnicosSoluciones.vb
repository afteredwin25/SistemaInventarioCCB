...
Public Class frmTecnicosSoluciones


    Private tabla_puestos As New DataTable

    Private Sub frmTecnicosSoluciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub Insertar()
        ...
        adaptador = New SqlDataAdapter("SELECT * FROM TecnicosSoluciones WHERE Identidad = '" & txtIdentidad.Text & "'  ", obtenerconexion)
        tabla.Clear()
        adaptador.Fill(tabla)
        ...
        Else
            sql = " INSERT INTO TecnicosSoluciones(Identidad, NombreTecnico, IdPuesto )
                     VALUES ('" & txtIdentidad.Text & "', '" & txtNombreTecnico.Text & "', '" & Trim(cboCargo.SelectedValue) & "') "
    ...
    Sub LlenarDatos()
        Dim sql As String
        sql = " Select TecnicosSoluciones.IdTecnico,TecnicosSoluciones.Identidad, TecnicosSoluciones.NombreTecnico, Puestos.NombreP  
                  FROM Puestos INNER JOIN  TecnicosSoluciones ON Puestos.IdPuesto = TecnicosSoluciones.IdPuesto"
        Try
    ...
    Sub BuscarDatos()
        If rbNombreEmpleado.Checked Then
            ...
            If txtBuscar.Text = "" Then
                LlenarDatos()
            End If
            adaptador = New SqlDataAdapter("Select TecnicosSoluciones.IdTecnico, TecnicosSoluciones.Identidad, TecnicosSoluciones.NombreTecnico,Puestos.NombreP
    ...
    Sub Editar()
        ...
        Else
            Dim sql As String
            sql = "UPDATE TecnicosSoluciones SET  Identidad = '" & txtIdentidad.Text & " ', NombreTecnico = '" & txtNombreTecnico.Text & "', 
                        IdPuesto =  '" & Trim(cboCargo.SelectedValue) & "'    WHERE IdTecnico = '" & txtId.Text & "'          "
            Dim conect As New SqlConnection(obtenerconexion)
            conect.Open()
            Using comando As New SqlCommand(sql, conect)
                id = comando.ExecuteScalar()
    ...
    Sub Eliminar()
        ...
        Else
            ...
            Else
                ...
                Dim sql As String
                sql = "DELETE FROM TecnicosSoluciones WHERE IdTecnico = " & Trim(txtId.Text)
    ...
    Private Sub dgvTecnicos_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvTecnicos.CellDoubleClick
        ...
        cboCargo.Text = CStr(dgvTecnicos.Item("IdPuesto", dgvTecnicos.CurrentCell.RowIndex).Value)

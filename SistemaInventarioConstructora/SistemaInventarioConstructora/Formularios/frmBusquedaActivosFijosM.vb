...
Public Class frmBusquedaActivosFijosM
    Private Sub frmBusquedaActivosFijosM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LlenarDatos()
        txtBuscar.Focus()
    ...
    Private Sub dgvActivosAsignados_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvActivosAsignados.CellDoubleClick
        ...
        frmMantenimientoActivos.txtIdArticulo.Text = CStr(dgvActivosAsignados.Item("IdArticulo", dgvActivosAsignados.CurrentCell.RowIndex).Value)
        frmMantenimientoActivos.txtNombreA.Text = CStr(dgvActivosAsignados.Item("NombreA", dgvActivosAsignados.CurrentCell.RowIndex).Value)
        frmMantenimientoActivos.txtCodigoI.Text = CStr(dgvActivosAsignados.Item("CodigoInventario", dgvActivosAsignados.CurrentCell.RowIndex).Value)


        frmMantenimientoActivos.txtIdCargo.Text = CStr(dgvActivosAsignados.Item("IdCargo", dgvActivosAsignados.CurrentCell.RowIndex).Value)
        frmMantenimientoActivos.txtNombreE.Text = CStr(dgvActivosAsignados.Item("Nombre", dgvActivosAsignados.CurrentCell.RowIndex).Value)
        frmMantenimientoActivos.txtIdentidad.Text = CStr(dgvActivosAsignados.Item("Identidad", dgvActivosAsignados.CurrentCell.RowIndex).Value)
        frmMantenimientoActivos.txtDepartamento.Text = CStr(dgvActivosAsignados.Item("NombreD", dgvActivosAsignados.CurrentCell.RowIndex).Value)


        frmMantenimientoActivos.DTPFechaEntrega.Text = CStr(dgvActivosAsignados.Item("FechaAsignacion", dgvActivosAsignados.CurrentCell.RowIndex).Value)
        Me.Close()
